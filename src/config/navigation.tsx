...
export const primaryNavigation: NavigationItem[] = [
  ...
  { key: "availability", moduleKey: "rooms", labelKey: "availability", path: "/availability-prices", Icon: CalendarIcon },
...
export const dashboardModules: NavigationItem[] = [
  ...
  { key: "availability", moduleKey: "rooms", labelKey: "availability", descriptionKey: "availabilityDescription", path: "/availability-prices", Icon: CalendarIcon, tone: "blue" },
