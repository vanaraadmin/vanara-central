...
function ConversationAvatar({
  ...
  return (
    <span className={`chat-avatar ${variant === "group" ? "chat-avatar--group" : ""}`} aria-hidden="true">
      {variant === "group" ? <img src={vanaraLogo} alt="" /> : photoUrl ? <img src={photoUrl} alt="" /> : <span>{label}</span>}
    </span>
  );
}
  ...
  return (
    ...
    >
      <ConversationAvatar
        ...
        variant={conversation.kind === "GROUP" ? "group" : "user"}
      />
...
export default function TeamChatSurface({
  ...
  return (
    <>
      <div className={`chat-app chat-app--${mode}`} data-internal-chat="team">
